...
Last updated: 2026-09-22 (`erp-dashboards` Phase 2 "Sales Dashboard" ✅ VERIFIED at agent level,
...
tests; program advances to Phase 3 (Purchase) and Phase 4 (Production), which may run in parallel;
nothing committed yet — see program details in Current Features below; prior: same date,
...
| `tests/` | `process/context/tests/all-tests.md` | Testing entrypoint for orderstock — Vitest 3.2.6 (282 tests/23 files) and Playwright E2E (49+ tests excl. [setup], incl. mobile + tablet projects, plus the erp-dashboards suite) both real and wired, sandbox SQL Server constraint |
